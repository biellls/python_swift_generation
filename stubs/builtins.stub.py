...
class List(Generic[T]):
    # SWIFT_WRAPPER.List: ExpressibleByArrayLiteral
    # SWIFT_WRAPPER.List: CPython
    # @not-overload
    def __init__(self): ...
    # @overload
...
# noinspection PyPep8Naming,PyShadowingBuiltins
class HomogeneousTuple(Generic[T]):
    # SWIFT_WRAPPER.List: ExpressibleByArrayLiteral
    # SWIFT_WRAPPER.HomogeneousTuple: CPython
    # def __new__(cls: Type[T], iterable: Iterable[T] = ...) -> T: ...
    # def __new__(cls: Type[T], iterable: Iterable[T] = ...) -> T: ...
    def __len__(self) -> int: ...
    ...
    # @overload
    # def __getitem__(self, x: slice) -> Tuple[T, ...]: ...
    # def __iter__(self) -> Iterator[T]: ...
    def __lt__(self, x: 'HomogeneousTuple[T]') -> bool: ...
    def __le__(self, x: 'HomogeneousTuple[T]') -> bool: ...
    def __gt__(self, x: 'HomogeneousTuple[T]') -> bool: ...
    def __ge__(self, x: 'HomogeneousTuple[T]') -> bool: ...
    def __add__(self, x: 'HomogeneousTuple[T]') -> 'HomogeneousTuple[T]': ...
    def __mul__(self, n: int) -> 'HomogeneousTuple[T]': ...
    def __rmul__(self, n: int) -> 'HomogeneousTuple[T]': ...
    def count(self, x: Any) -> int: ...
    def index(self, x: Any, start: int = 0, end: int = -1) -> int: ...


class Dict(Generic[T, V]):
    # SWIFT_WRAPPER.List: ExpressibleByDictionaryLiteral
    # SWIFT_WRAPPER.Dict: CPython
    # NOTE: Keyword arguments are special. If they are used, T must include
    #       str, but we have no way of enforcing it here.
    # @overload
    # def __init__(self, **kwargs: V) -> None: ...
    # @overload
    # def __init__(self, map: Mapping[T, V], **kwargs: V) -> None: ...
    # @overload
    # def __init__(self, iterable: Iterable[Tuple[T, V]], **kwargs: V) -> None: ...

    # def __new__(cls: Type[_T1], *args: Any, **kwargs: Any) -> _T1: ...

    def clear(self) -> None: ...
    def copy(self) -> 'Dict[T, V]': ...
    def popitem(self) -> Tuple[T, V]: ...
    def setdefault(self, k: T, default: V) -> V: ...
    # @overload
    # def update(self, __m: Mapping[T, V], **kwargs: V) -> None: ...
    # @not-overload
    # def update(self, __m: Iterable[Tuple[T, V]], **kwargs: V) -> None: ...
    # def update(self, __m: List[Tuple[T, V]]) -> None: ...
    # @overload
