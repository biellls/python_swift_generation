from typing import overload, Union, SupportsInt, Text, Sequence, Tuple, Optional, Any, Iterator
...
class str:
    ...
    def count(self, x: Text, __start: Optional[int] = None, __end: Optional[int] = None) -> int: ...
    ...
    def find(self, sub: Text, __start: Optional[int] = None, __end: Optional[int] = None) -> int: ...
    # def format(self, *args: object, **kwargs: object) -> 'str': ...
    # def format_map(self, map: Mapping['str', Any]) -> 'str': ...
    def index(self, sub: Text, __start: Optional[int] = None, __end: Optional[int] = None) -> int: ...
    ...
    def rfind(self, sub: Text, __start: Optional[int] = None, __end: Optional[int] = None) -> int: ...
    def rindex(self, sub: Text, __start: Optional[int] = None, __end: Optional[int] = None) -> int: ...
